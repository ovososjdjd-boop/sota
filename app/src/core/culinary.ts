...
/**
 * Продукты глубокой переработки (колбасы, сосиски).
 * ВОЗ относит переработанное мясо к канцерогенам группы 1 и рекомендует
 * ограничивать потребление. Оптимизатор их любит: дёшево и белково —
 * реальный прогон давал 18 сосисок как ЕДИНСТВЕННЫЙ источник мяса.
 */
export const PROCESSED_MAX_GRAMS_PER_PERSON_DAY = 50;

/**
 * Минимум разных продуктов внутри белковых категорий.
 * Одна позиция на всю неделю — это не рацион, а монотонность.
 */
export const MIN_PROTEIN_VARIETY = 3;
